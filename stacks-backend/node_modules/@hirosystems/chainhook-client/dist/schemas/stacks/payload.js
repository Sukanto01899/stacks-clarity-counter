...
exports.StacksPayloadSchema = exports.StacksEventSchema = exports.StacksEventMetadataSchema = exports.StacksTransactionMetadataSchema = exports.StacksTransactionPositionSchema = exports.StacksTransactionReceiptSchema = exports.StacksExecutionCostSchema = void 0;
...
exports.StacksTransactionMetadataSchema = typebox_1.Type.Object({
    ...
    contract_abi: typebox_1.Type.Optional(typebox_1.Type.Any()),
});
...
exports.StacksEventMetadataSchema = typebox_1.Type.Object({
    ...
    confirm_microblock_identifier: (0, common_1.Nullable)(common_1.BlockIdentifierSchema),
...
exports.StacksPayloadSchema = typebox_1.Type.Object({
    apply: typebox_1.Type.Array(exports.StacksEventSchema),
    rollback: typebox_1.Type.Array(exports.StacksEventSchema),
    chainhook: typebox_1.Type.Object({
        uuid: typebox_1.Type.String(),
        predicate: if_this_1.StacksIfThisSchema,
