...
exports.BitcoinIfThisOrdinalsMetaProtocolSchema = typebox_1.Type.Union([
    typebox_1.Type.Literal('all'),
    typebox_1.Type.Literal('brc-20'),
]);
exports.BitcoinIfThisOrdinalsFeedSchema = typebox_1.Type.Object({
    ...
    meta_protocols: typebox_1.Type.Optional(typebox_1.Type.Array(exports.BitcoinIfThisOrdinalsMetaProtocolSchema)),
});
